...
function flei_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'flei_projects_page_id' , array(
        'default'     => 0,
        'transport'   => 'refresh',
    ) );

    $wp_customize->add_setting( 'flei_social_fb_url' , array(
        'default'     => 0,
        'transport'   => 'refresh',
    ) );

    $wp_customize->add_setting( 'flei_social_xing_url' , array(
        'default'     => 0,
        'transport'   => 'refresh',
    ) );

    $wp_customize->add_setting( 'flei_social_linkedin_url' , array(
        'default'     => 0,
        'transport'   => 'refresh',
    ) );

    // declare sections
    $wp_customize->add_section( 'flei_projects_section' , array(
        'title'      => __( 'Projekte', 'flei' ),
        'priority'   => 30,
    ) );

    $wp_customize->add_section( 'flei_social_section' , array(
